          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A fast chat-oriented version of the report agent with four specialist tools and access to MiroFish's full memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation state and uses global/local memory to produce deep causal analysis across time.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Traverses the graph broadly to reconstruct propagation paths and capture the topology of information flow.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">A GraphRAG-based instant query interface for quickly extracting concrete node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Runs autonomous interviews with simulated individuals in parallel to collect unstructured opinions and psychological state.</div>
                  </div>
                </div>
              </div>
            </div>
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Automatically save the chat history into the cache
    saveChatHistory()
  }
}
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    // The correct data path is res.data.result.results, which is an object dictionary
    // Format: {"twitter_0": {...}, "reddit_0": {...}} or a single-platform response like {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // Convert the object dictionary to an array, preferring replies from the Reddit platform
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prefer Reddit replies first, then Twitter
...
/* Left Panel - Report style (kept fully consistent with Step4Report.vue) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* Fix ordered-list numbering by using CSS counters across multiple ol blocks */
.message-text {
...
/* Quote styles for the chat/questionnaire area */
