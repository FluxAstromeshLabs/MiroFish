    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes the documents and simulation objective, extracts real-world seeds, and generates a suitable ontology automatically.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the generated ontology, the system chunks documents automatically, calls Zep to build the knowledge graph, extracts entities and relations, and forms temporal memory plus community summaries.
          </p>
...
// Enter environment setup by creating the simulation and redirecting
