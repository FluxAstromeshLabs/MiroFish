    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even a single paragraph is enough for <span class="highlight-bold">MiroFish</span> to derive real-world seeds and automatically generate a parallel world populated by up to <span class="highlight-orange">millions of agents</span>. Inject variables from a god-view and search for the <span class="highlight-code">"local optimum"</span> inside complex collective behavior.
            </p>
            <p class="slogan-text">
              Let the future play out among agents before your decision has to.<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            The prediction engine is standing by. Upload unstructured sources to initialize a simulation run.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Extract entity relations, generate personas, and configure agent simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Run two platforms in parallel, parse the forecast objective, and update temporal memory dynamically</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Report Agent uses a rich toolset to deeply analyze the post-simulation world</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Talk to any simulated individual or continue the analysis with Report Agent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe the simulation or forecast goal in natural language"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start the simulation - navigate immediately and let the Process page make the API call
...
/* Project simulation workflow overview */
.steps-container {
  border: 1px solid var(--border);
  padding: 30px;
  position: relative;
