...
/**
 * Get agent profiles while they are being generated.
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Get simulation config while it is being generated.
 * @param {string} simulationId
 * @returns {Promise} Returns configuration data with metadata and content
 */
...
/**
 * Get live simulation run status.
 * @param {string} simulationId
 */
...
/**
 * Get posts generated in the simulation.
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
