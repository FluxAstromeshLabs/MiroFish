"""
Test whether generated profile formats satisfy OASIS requirements.
Checks:
1. Twitter profiles are generated as CSV.
2. Reddit profiles are generated as detailed JSON.
"""
...
def show_expected_formats():
    ...
    print("\n" + "=" * 60)
    print("Reference for OASIS expected profile formats")
    print("=" * 60)
