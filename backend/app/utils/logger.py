...
Provide unified logging to both console and files.
"""
...
def _ensure_utf8_stdout():
    ...
    This avoids garbled non-ASCII output in the Windows console.
    """
...
def setup_logger(name: str = 'mirofish', level: int = logging.DEBUG) -> logging.Logger:
    ...
    # 1. File handler: detailed logs with date-based filenames and rotation.
