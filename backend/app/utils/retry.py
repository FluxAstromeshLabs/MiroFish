...
Used for retry logic around external APIs such as LLM providers.
"""
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Process a batch and retry each failed item independently.
        
        Args:
            items: List of items to process.
            process_func: Handler function that accepts one item.
            exceptions: Exception types to retry.
            continue_on_failure: Whether to continue after a single-item failure.
