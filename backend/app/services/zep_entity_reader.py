...
class ZepEntityReader:
    ...
    2. Filter nodes that match predefined entity types, meaning labels beyond just `Entity`.
    3. Retrieve related edges and connected nodes for each entity.
    """
    ...
    def _call_with_retry(
        ...
        Args:
            func: Callable to execute, typically a no-arg lambda.
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Get all graph edges using pagination.
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Get all edges related to a specific node, with retries.
    ...
    def filter_defined_entities(
        ...
        - If a node has labels besides `Entity` and `Node`, it matches a predefined type and is kept.
        
        Args:
            graph_id: Graph ID.
            defined_entity_types: Optional list of predefined entity types; when provided, only those types are kept.
        ...
        # Fetch all edges for later relationship lookups.
        ...
        for node in all_nodes:
            ...
            # Filtering logic: labels must include something other than `Entity` and `Node`.
            custom_labels = [l for l in labels if l not in ["Entity", "Node"]]
            
            if not custom_labels:
                # Only default labels are present, so skip the node.
                continue
            
            # If predefined types were provided, require a match.
            ...
            # Gather related edges and nodes.
