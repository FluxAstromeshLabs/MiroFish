...
# This must be configured before all other imports.
...
def create_app(config_class=Config):
    ...
    # Configure JSON encoding to emit UTF-8 directly instead of \uXXXX escapes.
    ...
    # Log startup messages only in the reloader child process to avoid duplicate output in debug mode.
